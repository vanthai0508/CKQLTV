...
public class DangKy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_dang_ky);
    ...
    public void backFromRegister(View view){
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(DangKy.this,pairs);
    ...
    public void byBundleNextSignupScreen(String hoTen, String tenDN, String eMail, String sDT, String matKhau){
        ...
        Intent intent = new Intent(getApplicationContext(),DangKyNS.class);
    ...
    private boolean validateFullName(){
        ...
        if(val.isEmpty()){
            TXTL_signup_HoVaTen.setError("khong duoc de trong");
            return false;
        }else {
    ...
    private boolean validateUserName(){
        ...
        if(val.isEmpty()){
            TXTL_signup_TenDN.setError("khong duoc de trong");
            return false;
    ...
    private boolean validateEmail(){
        ...
        if(val.isEmpty()){
            TXTL_signup_Email.setError("khong duoc de trong");
            return false;
        }else if(!val.matches(checkspaces)){
    ...
    private boolean validatePhone(){
        ...
        if(val.isEmpty()){
            TXTL_signup_SDT.setError("khong duoc de trong");
            return false;
    ...
    private boolean validatePassWord(){
        ...
        if(val.isEmpty()){
            TXTL_signup_MatKhau.setError("khong duoc de trong");
            return false;
